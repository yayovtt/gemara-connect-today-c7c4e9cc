...
import { Search, Calendar, Building2, FileText, ExternalLink, Loader2, Sparkles, Zap } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <Tabs defaultValue="search" className="space-y-6">
          <TabsList className="grid w-full max-w-md grid-cols-2 mx-auto">
            ...
            <TabsTrigger value="batch-analysis" className="gap-2">
          ...
          <TabsContent value="batch-analysis">
            <BatchAnalysisPanel />
          </TabsContent>
        </Tabs>
      </div>
